...
const projects = [
  {
    ...
    image: "https://images.unsplash.com/photo-1539109132314-3477524c859c?q=80&w=1000&auto=format&fit=crop", // High-quality placeholder
  },
  {
    id: "02",
      ...
      <div className="relative z-10 glass rounded-3xl overflow-hidden transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-[0_20px_50px_rgba(168,85,247,0.1)]">
        ...
        <div className="p-8">
          <div className="flex justify-between items-start mb-4">
            ...
            <a href={project.link} target="_blank" rel="noopener noreferrer" className="p-2 glass rounded-full hover:bg-white/10 transition-colors">
              <Github size={20} />
            </a>
          </div>
